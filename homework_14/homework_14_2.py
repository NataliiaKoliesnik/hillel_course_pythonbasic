# робота з класами і винятками: цифровий лічильник
...
class Counter:
   ...
   def set_max(self, max_max):
       ...
       if self.current > max_max:
           raise ValueError('Значення не може бути більшим за максимум')
   ...
   def set_min(self, min_min):
       ...
       if self.current < min_min:
           raise ValueError('Значення не може бути меншим за мінімум')
       self.min_value = min_min

   def step_up(self):
       if self.current == self.max_value:
           raise ValueError('Досягнено максимуму')
       self.current += 1
